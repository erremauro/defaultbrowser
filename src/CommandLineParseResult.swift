...
//  defaultbrowser
//
//  Created by Kristopher Johnson on 18/02/2017.
//
...
extension String {
    ...
    func substring(fromNumericIndex numericIndex: Int) -> String {
        let lowerBoundIndex = String.Index(utf16Offset: numericIndex, in: self)
        return String(self[lowerBoundIndex...])
    }
}
...
public struct CommandLineParseResult {
        ...
        where StringIterator.Element == String
    {
        ...
        if argument.hasPrefix("-") && argument.count > 1 {
            ...
            for (n, letter) in letters.enumerated() {
